...
class DatasetFactory:
    from datasets.classification.cifar10 import CIFAR10
    from datasets.classification.imagenet100 import ImageNet100
    from datasets.classification.imagenet import ImageNet
    from datasets.classification.cifar100 import CIFAR100, OrderedCIFAR100VAL
    from datasets.classification.normal import NormalFullDataset
    from datasets.super_resolution import SRFullDataset

    dataset_params: dict
    all_datasets = [CIFAR10, CIFAR100, ImageNet100, OrderedCIFAR100VAL, NormalFullDataset, ImageNet, SRFullDataset]
