...
def _wide_resnet(arch, depth, widen_factor, pretrained, device, **kwargs):
    model = WideResNet(depth, widen_factor=widen_factor, **kwargs)
    if pretrained:
...
# @register_model
# def wrn40x4(pretrained=False, device='cpu', **kwargs):
...
#     """
#     return _wide_resnet('wrn40x4', 40, 4, pretrained, device, **kwargs)
