...
class ResNet(nn.Module):
    ...
    def __init__(self, depth, num_filters, block_name='BasicBlock', num_classes=10, input_channel=3):
        ...
        self.conv1 = nn.Conv2d(input_channel, num_filters[0], kernel_size=3, padding=1,
                               bias=False)
...
if __name__ == '__main__':
    ...
    feats, logit = net(x_test, with_feature=True, pre_act=True)
