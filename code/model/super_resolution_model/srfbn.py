...
class SRFBN_model(nn.Module):
    def __init__(self, scale, in_channels=3, out_channels=3, num_features=64, num_steps=4, num_groups=6, act_type='prelu',
                 norm_type=None, **kwargs):
        super(SRFBN_model, self).__init__()
        ...
        # basic block
        self.block = FeedbackBlock(num_features, num_groups, scale, act_type, norm_type)
