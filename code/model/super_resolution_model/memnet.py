"""MemNet from https://github.com/Vandermode/pytorch-MemNet"""
import torch
...
@register_model
def MemNet(**kwargs):
    model = MemNet_Model(**kwargs)
    return model


class MemNet_Model(nn.Module):
    def __init__(self, scale, in_channels=3, channels=64, num_memblock=6, num_resblock=6, **kwargs):
        super(MemNet_Model, self).__init__()
        self.scale = scale
...
"""correction to pytorch implemention by https://github.com/Vandermode/pytorch-MemNet/issues/3"""
...
class MemoryBlock(nn.Module):
    ...
    def __init__(self, channels, num_resblock, num_memblock):
        ...
        self.recur_block = ResidualBlock(channels)
